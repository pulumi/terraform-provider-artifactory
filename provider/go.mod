module github.com/pulumi/pulumi-artifactory/provider/v8
...
require (
	github.com/jfrog/terraform-provider-artifactory/v12 v12.7.1
...
require (
	...
	github.com/jfrog/terraform-provider-shared v1.27.1 // indirect
